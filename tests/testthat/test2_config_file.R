...
test_that("Testing config file workflow", {
  ...
  result <- palmsplus_shell(palms_data = palms, config_file = config, return_list = TRUE, verbose = FALSE)
  ...
  result <- palmsplus_shell(palms_data = palms, config_file = config, multimodal = FALSE, return_list = TRUE, verbose = FALSE)
  ...
  result <- palmsplus_shell(palms_data = palms, config_file = config, trajectories = FALSE, return_list = TRUE, verbose = FALSE)
  ...
  result <- palmsplus_shell(palms_data = palms, config_file = config, days = FALSE, return_list = TRUE, verbose = FALSE)
  ...
  result <- palmsplus_shell(palms_data = palms, config_file = config, trajectories = FALSE, days = FALSE, return_list = TRUE, verbose = FALSE)
