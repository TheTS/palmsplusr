...
The development version of ggplot2 contains spatial plotting functions so it needs to be installed from GitHub.
...
for (i in unique(trajectories$identifier)) {
  ...
  s <- school %>% filter(school_id == as.numeric(
                   participant_basis[participant_basis$identifier == i, "school_id"]))
  ...
  ggsave(file = file.path("plots", paste0(i, ".png")), plot = p, 
