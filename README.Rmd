...
* A `field` is variable calculated from combinations of existing variables. An exmample field is *at_school* which might return `TRUE` if the PALMS point falls inside a polygon representing the schoolyard.
