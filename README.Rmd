...
In addition to `palmsplus_fields`, there are three other field tables 
...
* `trajectory_locations` is used to specify trip start and end locations (e.g., home-school)
* `multimodal_fields` is used to specify the fields sumarized in `multimodal`
